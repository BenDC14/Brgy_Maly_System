...
Public Class AyudaEditRecording_Form
    ...
    Private responsiveManager As AyudaEditRecordingResponsiveManager
    ...
    Private Sub AyudaEditRecording_Form_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        responsiveManager = New AyudaEditRecordingResponsiveManager(Me)
    ...
    ' ========================================
    ' - Load resident data into fields (txtResidentName, txtAge, txtSex, txtCategory, txtHousehold)
